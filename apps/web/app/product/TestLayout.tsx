...
const navigation = [
  ...
  { name: 'Patients', href: '/protected/patients', icon: UsersIcon },
  { name: 'Documents', href: '/protected/documents', icon: FolderIcon },
  { name: 'Statistics', href: '/protected/dashboard/stats', icon: ChartPieIcon },
]
                  ...
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    <li>
                      <ul role="list" className="-mx-2 space-y-1">
                        {navigation.map((item) => {
                          const isActive = item.href === '#' ? pathname === '/protected' : pathname.startsWith(item.href);
            ...
            >
              <MenuItems className="absolute right-0 z-10 mt-2.5 w-48 origin-top-right rounded-md bg-popover py-2 shadow-lg ring-1 ring-foreground/5 focus:outline-none dark:bg-popover dark:ring-foreground/10">
                ...
                <MenuItem>
                  {({ focus }) => (
                    <Link
                      href="/protected/settings" // Example link, adjust as needed
                      className={cn(
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-border bg-background px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">
              <img
                ...
                className={classNames(
                  ...
                  isDesktopSidebarCollapsed ? 'w-auto' : 'w-auto' // Keep logo aspect ratio, maybe adjust parent alignment if needed
                )}
              />
            ...
            {!isDesktopSidebarCollapsed && (
              <ul role="list" className="mt-auto">
                <li className="-mx-6">
                  <Link
                    href="/protected/settings" // Updated href from /protected/profile
